...
resource "aws_rds_cluster_parameter_group" "aurora_postgre_12" {
  name   = "${var.tags_owner}-${var.tags_env}-clspg-aurora-postgre-12"
...
resource "aws_db_parameter_group" "aurora_postgre_12" {
  name   = "${var.tags_owner}-${var.tags_env}-pg-aurora-postgre-12"
  family = "aurora-postgresql12"
  tags = {
    Owner = var.tags_owner
    Env   = var.tags_env
