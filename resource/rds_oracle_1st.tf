...
resource "aws_db_parameter_group" "oracle_121se2" {
  name   = "${var.tags_owner}-${var.tags_env}-pg-oracle-121se2"
...
resource "aws_db_option_group" "oracle_18" {
  name                 = "${var.tags_owner}-${var.tags_env}-opg-oracle-18"
  engine_name          = "oracle-se2"
...
resource "aws_db_option_group" "oracle_121se2" {
  name                 = "${var.tags_owner}-${var.tags_env}-opg-oracle-121se2"
  engine_name          = "oracle-se2"
